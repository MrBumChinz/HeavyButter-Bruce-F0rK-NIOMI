...
#   upstream_url  - upstream server to sync from (default: http://ghp.iceis.co.uk)
#   appstore_url  - your self-hosted URL (default: http://localhost:8080)
#
# Examples:
#   ./sync.sh                              # dev defaults
#   ./sync.sh http://ghp.iceis.co.uk https://appstore.heavybutter.sh

set -euo pipefail

UPSTREAM="${1:-http://ghp.iceis.co.uk}"
APPSTORE_URL="${2:-http://localhost:8080}"
...
echo ""
echo "=== Sync Complete ==="
echo "Run 'docker compose restart' to apply changes."
echo "App Store URL: ${APPSTORE_URL}"
